# stm32-module
Hello! This is my first MCU Module, made for HackClub's Blueprint program. It features 66 goldpins, USB-C port for data AND power, integrated 3.3V and 1.8V LDO and ESD protection on VBUS, DATA channels and CC channels! It uses 4 layer pcb (Front and Back are for power, IN1 and IN2 for GPIO connection). It uses STM32H7 64-LQFP Package MCU on it!
# Images
TODO
# Datasheets
Here you can find datasheet for every part i used:
- MCU: [STM Electronics STM32H7B0RBT6 LQFP-64 Package](Datasheets/STM32H7B0RBT6.pdf)
- Port: [Molex 216990-0003](Datasheets/216990-0003.pdf)
